...
All documentation is written in Markdown format and stored in the `docs/` directory. To edit the documentation:

1. Navigate to the appropriate content file in the VitePress documentation structure
...
1. Create a new Markdown file in the appropriate documentation directory
2. Add the frontmatter at the top of the file
3. Write the content using Markdown
4. Update the sidebar configuration in `.vitepress/config.ts` to include the new page

## Images and Assets

To add images to your documentation:

1. Add the image to the `docs/public/` directory
...
1. Run the development server with `npm run docs:dev`
